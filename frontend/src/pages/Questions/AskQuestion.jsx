...
export default function AskQuestion() {
  ...
  const limitPercent =
    limitInfo?.limit === Infinity || limitInfo?.remaining === "Unlimited"
      ? 100
      : limitInfo
        ? Math.round((limitInfo.used / limitInfo.limit) * 100)
        : 0;
        ...
        >
          <div className="flex items-center justify-between px-4 py-3">
            ...
            >
              ...
              {" · "}
              {limitInfo.used} of{" "}
              {limitInfo.limit === Infinity ? "∞" : limitInfo.limit} used today
            </span>
            <span
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          <div>
            ...
            <input
              ...
              required
              disabled={isBlocked}
              className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-[14px] text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400 transition-colors disabled:opacity-50"
            />
          ...
          <div>
            ...
            <textarea
              ...
              rows={7}
              disabled={isBlocked}
              className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-[14px] text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400 transition-colors resize-y disabled:opacity-50"
            />
          </div>
